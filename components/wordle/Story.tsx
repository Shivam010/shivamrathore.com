                        ...
                        <div className=" mt-1 flex justify-start items-stretch gap-2">
                            ...
                            <button className="group flex justify-center">
                                <svg
                                    ...
                                    viewBox="0 0 16 16"
                                    className="mt-1 fill-rang-300 h-4 w-4 group-hover:fill-red-600 group-hover:scale-150 group-hover:animate-[spin_1s_ease_infinite] duration-700 "
                                >
                                    <path
                                        fillRule="evenodd"
                            ...
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    aria-hidden="true"
                                    className=" fill-rang-300 group-hover:fill-blue-400 h-5 w-5 group-hover:scale-150 group-hover:-rotate-12 group-hover:animate-spin duration-700"
                                    viewBox="0 0 24 24"
                                >
